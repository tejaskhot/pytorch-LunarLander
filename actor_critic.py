...
def main():
    ...
    parser.add_argument("--lr_actor", type=float, default=5e-3, help="learning rate actor (default = 1e-2)")
    parser.add_argument("--lr_critic", type=float, default=5e-3, help="learning rate critic (default = 1e-2)")
